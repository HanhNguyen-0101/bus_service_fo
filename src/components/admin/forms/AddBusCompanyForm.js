...
import { addBusCompany } from "../../../redux/actions/BusCompanyAction";
import { Review } from "../../../models/BusCompanyModel";
import _ from "lodash";

export default function AddBusCompanyForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(addBusCompany(formData));
    },
  });
  useEffect(() => {
