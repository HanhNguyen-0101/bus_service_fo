...
import { addArticle, getAllHashtag } from "../../../redux/actions/GlobalAction";
const { Option } = Select;
...
export default function AddArticleForm() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      subTitle: Yup.string().required(t("pleaseInput", {title: t("subTitle")})),
    ...
    >
      ...
      >
        <Select
          ...
          defaultValue={formik.values.hashtag}
