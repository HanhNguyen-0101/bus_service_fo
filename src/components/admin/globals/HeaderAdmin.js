...
export default function HeaderAdmin() {
  ...
  return (
    <header
      className="p-2 dark:bg-gray-800 dark:text-gray-100 site-layout-background bg-white"
      style={{ boxShadow: "rgba(0, 0, 0, 0.05) 0px 3px 5px" }}
    >
      <div className="flex flex-col justify-between lg:justify-end lg:items-end h-16 mx-auto">
        <div
              ...
              content={
                <ul>
                  <li className="px-3 py-1.5">
                    <NavLink
                      to="/profile"
                      className="focus-visible:outline-none focus:outline-none text-black font-medium capitalize bg-white rounded-sm hover:bg-white hover:text-alibus"
                    >
                      {userLogin.name}
                    </NavLink>
                  </li>
