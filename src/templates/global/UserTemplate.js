          ...
          <>
            <div>
              <div className="grid grid-cols-3">
                ...
                <div className="col-span-2 hidden lg:flex items-center justify-center bg-alibusblurv flex-1 h-screen">
                  <NavLink
                    to="/home"
                    aria-label="Go to homepage"
                    className="flex items-center p-2"
                  >
                    <img src="favicon.png" width={120} alt="favicon.png" />
                    <h1 className="text-6xl px-2 font-bold text-alibus font-sans">
                      AliBus
                    </h1>
                  </NavLink>
